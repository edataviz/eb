<?php
$currentSubmenu ='/ghg/es/indirect';
$mainTab        = 'IndirectEmissionGroup';
$tables         = [$mainTab	=>['name'=>'Data Input']];
$isAction = true;
$detailTableTab = 'IndirectEmissionCalcMethod';
?>
...
@section('adaptData')
    @parent
    <script>
        actions.loadUrl = "/indirect/es/load";
        actions.saveUrl = "/indirect/es/save";
        ...
        // lấy ra parent id
        actions['idNameOfDetail'] = ['INDIRECT_EMISSION_GROUP_ID','ID','EFFECTIVE_DATE'];

        actions['doMoreAddingRow'] = function(addingRow){
            addingRow['INDIRECT_EMISSION_GROUP_ID'] = pid;

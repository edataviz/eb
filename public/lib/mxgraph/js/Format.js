 ...
 * Adds the given option.
 */
BaseFormatPanel.prototype.createOption = function(label, isCheckedFn, setCheckedFn, listener, id)
{
	var div = document.createElement('div');
...
DiagramFormatPanel.prototype.addOptions = function(div)
{
	...
	if (graph.isEnabled())
	{
		...
		// Auto fit
		div.appendChild(this.createOption('Fit on loaded', function()
		{
		}, function(checked)
		{
		},
		...
		// Auto update
		div.appendChild(this.createOption('Auto update', function()
		{
		}, function(checked)
		{
		},

...
Sidebar.prototype.init = function()
{
    ...
    //this.addEnergyPalette(true);
	window.enableDashboardCategory && this.addDashboardItems();
    this.addEnergyBuilderItems('energy', 'Energy Builder', '/'+dir + '/draw2/', '_128x128.png',
        [
			{name : 'eb_oilwell',attributes : {label : "Oil well", object_id : "", object_type : "ENERGY_UNIT",href:"", surveillance:" "}},
			{name : 'eb_gaswell',attributes : {label : "Gas well", object_id : "", object_type : "ENERGY_UNIT",href:"", surveillance:" "}},  
			{name : 'eb_oilmetter',attributes : {label : "Oil meter", object_id : "", object_type : "FLOW",href:"", surveillance:" "}}, 
			{name : 'eb_gasmetter',attributes : {label : "Gas meter", object_id : "", object_type : "FLOW",href:"", surveillance:" "}},  
			{name : 'eb_watermetter',attributes : {label : "Water meter", object_id : "", object_type : "FLOW",href:"", surveillance:" "}},  
			{name : 'eb_oilpump',attributes : {label : "Oil pump", object_id : "", object_type : "EQUIPMENT",href:"", surveillance:" "}}, 
			{name : 'eb_waterpump',attributes : {label : "Water pump", object_id : "", object_type : "EQUIPMENT",href:"", surveillance:" "}},  
			{name : 'eb_oiltank',attributes : {label : "Oil tank", object_id : "", object_type : "TANK",href:"", surveillance:" "}},  
			{name : 'eb_watertank',attributes : {label : "Water tank", object_id : "", object_type : "TANK",href:"", surveillance:" "}}, 
			{name : 'eb_compressor',attributes : {label : "Compressor", object_id : "", object_type : "EQUIPMENT",href:"", surveillance:" "}}, 
			{name : 'eb_flare',attributes : {label : "Flare", object_id : "", object_type : "",href:"", surveillance:" "}},  
			{name : 'eb_separator',attributes : {label : "Separator", object_id : "", object_type : "EQUIPMENT",href:"", surveillance:" "}},  
			{name : 'eb_waterinjection',attributes : {label : "Water injection", object_id : "", object_type : "ENERGY_UNIT",href:"", surveillance:" "}},  
			{name : 'eb_gasinjection',attributes : {label : "Gas injection", object_id : "", object_type : "ENERGY_UNIT",href:"", surveillance:" "}},  
			{name : 'eb_sagdwell',attributes : {label : "SAGD Well", object_id : "", object_type : "ENERGY_UNIT",href:"", surveillance:" "}},  
			{name : 'eb_trucktransport',attributes : {label : "Truck transport", object_id : "", object_type : "",href:"", surveillance:" "}},
			{name : 'eb_traintransport',attributes : {label : "Train transport", object_id : "", object_type : "",href:"", surveillance:" "}},  
			{name : 'eb_lngplant',attributes : {label : "LNG Plant", object_id : "", object_type : "",href:"", surveillance:" "}},  
			{name : 'eb_gasplant',attributes : {label : "Gas plant", object_id : "", object_type : "",href:"", surveillance:" "}}, 
			{name : 'eb_nglplant',attributes : {label : "NGL Plant", object_id : "", object_type : "",href:"", surveillance:" "}}, 
			{name : 'eb_fpso',attributes : {label : "FPSO", object_id : "", object_type : "",href:"", surveillance:" "}}, 
			{name : 'eb_fso',attributes : {label : "FSO", object_id : "", object_type : "",href:"", surveillance:" "}}, 
			{name : 'eb_subseatemplate',attributes : {label : "Subsea Template", object_id : "", object_type : "",href:"", surveillance:" "}}, 
			{name : 'eb_wellpad',attributes : {label : "Wellpad", object_id : "", object_type : "ENERGY_UNIT_GROUP",href:"", surveillance:" "}}, 
			{name : 'eb_battery',attributes : {label : "Battery", object_id : "", object_type : "",href:"", surveillance:" "}}, 
			{name : 'eb_singlewelloilbattery',attributes : {label : "Single-well Oil Battery", object_id : "", object_type : "",href:"", surveillance:" "}}, 
			{name : 'eb_subnetwork',attributes : {label : "Subnetwork", object_id : "", object_type : "",href:"", surveillance:" "}}, 
			{name : 'eb_completion',attributes : {label : "Completion", object_id : "", object_type : "",href:"", surveillance:" "}},
			{name : 'eb_lngtankership',attributes : {label : "LNG Tanker Ship", object_id : "", object_type : "",href:"", surveillance:" "}},
			{name : 'eb_gastankership',attributes : {label : "Tanker ship", object_id : "", object_type : "",href:"", surveillance:" "}},
			{name : 'eb_dehydration',attributes : {label : "Dehydration", object_id : "", object_type : "EQUIPMENT",href:"", surveillance:" "}},
			{name : 'eb_mercuryremoval',attributes : {label : "Mercury Removal", object_id : "", object_type : "EQUIPMENT",href:"", surveillance:" "}},
			{name : 'eb_lngtank',attributes : {label : "LNG Tank", object_id : "", object_type : "TANK",href:"", surveillance:" "}},
			{name : 'eb_fuel',attributes : {label : "Fuel", object_id : "", object_type : "",href:"", surveillance:" "}},
			{name : 'eb_ultrasonicgasmeter',attributes : {label : "Ultrasonic Gas Meter", object_id : "", object_type : "",href:"", surveillance:" "}},
			{name : 'eb_generator',attributes : {label : "Generator", object_id : "", object_type : "",href:"", surveillance:" "}},
			{name : 'eb_pipelineoil',attributes : {label : "Oil Pipeline", object_id : "", object_type : "",href:"", surveillance:" "}}, 
			{name : 'eb_pipelinegas',attributes : {label : "Gas Pipeline", object_id : "", object_type : "",href:"", surveillance:" "}}, 
			{name : 'eb_pipelinewater',attributes : {label : "Water Pipeline", object_id : "", object_type : "",href:"", surveillance:" "}}, 
			{name : 'eb_pipelinefws',attributes : {label : "FWS Pipeline", object_id : "", object_type : "",href:"", surveillance:" "}}, 
			{name : 'eb_valve',attributes : {label : "Valve", object_id : "", object_type : "",href:"", surveillance:" "}}, 
			{name : 'endpoint',attributes : {label : "E", object_id : "", object_type : "",href:"", surveillance:" "}},
            /*
            {name : 'eb_oilwell',attributes : {label : "Gas well", object_id : "", object_type : "ENERGY_UNIT",href:"", surveillance:" "}},
             'eb_gaswell','eb_oilmetter','eb_gasmetter','eb_watermetter','eb_oilpump','eb_waterpump','eb_oiltank','eb_watertank','eb_compressor','eb_flare','eb_separator','eb_waterinjection',
            'eb_gasinjection','eb_sagdwell','eb_trucktransport','eb_traintransport','eb_lngplant','eb_gasplant','eb_nglplant','eb_fpso','eb_fso','eb_subseatemplate','eb_wellpad','eb_battery','eb_singlewelloilbattery',
            'eb_subnetwork','eb_completion','eb_lngtankership','eb_gastankership','eb_dehydration','eb_mercuryremoval','eb_lngtank','eb_fuel','eb_ultrasonicgasmeter','eb_generator','eb_pipelineoil','eb_pipelinegas',
            'eb_pipelinewater','eb_pipelinefws','eb_valve','endpoint'*/
        ], null,
...
/**
 * Adds the energy palette to the sidebar.
 */
Sidebar.prototype.addEnergyPalette = function(expand)
{
    var lineTags = 'line lines connector connectors connection connections arrow arrows ';
    var fns = [];
    this.addPaletteFunctions('energy', mxResources.get('energy'), (expand != null) ? expand : true, fns);
};
...
Sidebar.prototype.createEBVertexTemplate = function(itemOption,tags,style, width, height, value, title, showLabel, showTitle, allowCellsInserted)
{
	var cells = [new mxCell((value != null) ? value : '', new mxGeometry(0, 0, width, height), style)];
	cells[0].vertex = true;
	if (typeof(itemOption.attributes) !== "undefined") {
		for (var key in itemOption.attributes) {
			this.graph.setAttributeForCell(cells[0], key, itemOption.attributes[key]);
			//cells[0].setAttribute(key, itemOption.attributes[key]);
		}
	}
	return this.createVertexTemplateFromCells(cells, width, height, title, showLabel, showTitle, allowCellsInserted);
};
...
Sidebar.prototype.addEnergyBuilderItems = function(id, title, prefix, postfix, items, titles, tags)
{
	var showTitles = titles != null;
	var fns = [];
	...
	for (var i = 0; i < items.length; i++)
	{
		(mxUtils.bind(this, function(item, title, tmpTags,itemOption)
		{
			if (tmpTags == null)
			{
				var slash = item.lastIndexOf('/');
				var dot = item.lastIndexOf('.');
				tmpTags = item.substring((slash >= 0) ? slash + 1 : 0, (dot >= 0) ? dot : item.length).replace(/[-_]/g, ' ');
				if(itemOption!=null&&itemOption.attributes!=null&&itemOption.attributes.label)
					tmpTags +=" "+itemOption.attributes.label;
			}
			if (title == null && itemOption!=null&&itemOption.attributes!=null&&itemOption.attributes.label)
				title= itemOption.attributes.label;
			fns.push(this.createEBVertexTemplateEntry('image;html=1;labelBackgroundColor=#ffffff;image=' + prefix + item + postfix,
				this.defaultImageWidth, this.defaultImageHeight, '', title, false, null, this.filterTags(tmpTags),itemOption));
		}))(items[i].name, (titles != null) ? titles[i] : null, (tags != null) ? tags[items[i].name] : null,items[i]);
	}

	this.addPaletteFunctions(id, title, false, fns);
};

Sidebar.prototype.addDashboardItems = function()
{
	var fns = [];
	//fns.push(this.createEBVertexTemplateEntry('html=1;dashed=1;fillColor=none', 120, 80, '<div class="html-box center-box"><p><img height="32" src="' + STENCIL_PATH + '/clipart/gear.png"><br>Workflow</p></div>', 'Workflow', null, null, 'label', {attributes: {type: "workflow", config: " "}}));
	fns.push(this.createEBVertexTemplateEntry('html=1;dashed=1;fillColor=none', 120, 80, '<div class="html-box center-box"><p><img height="32" src="' + STENCIL_PATH + '/clipart/chart.png"><br><span class="chart-name">Chart</span></p></div>', 'Chart', null, null, 'label', {attributes: {type: "chart", config: " "}}));
	fns.push(this.createEBVertexTemplateEntry('html=1;dashed=1;fillColor=none', 120, 80, '<div class="html-box center-box"><p><img height="32" src="' + STENCIL_PATH + '/clipart/gauge.png"><br>Gauge</p></div>', 'Gauge', null, null, 'label', {attributes: {type: "gauge", config: " "}}));
	fns.push(this.createEBVertexTemplateEntry('html=1;dashed=1;fillColor=none', 120, 80, '<div class="html-box center-box"><p><img height="32" src="' + STENCIL_PATH + '/clipart/grid.png"><br>Data grid</p></div>', 'Data grid', null, null, 'label', {attributes: {type: "datagrid", config: " "}}));
	//fns.push(this.createEBVertexTemplateEntry('whiteSpace=wrap;fillColor=#FFFFCC;strokeColor=#B3B3B3;dashed=1;dashPattern=1 1;align=left;verticalAlign=top;horizontal=1;html=1;spacingLeft=5;', 120, 40, 'Formated text', 'Formated data text block', null, null, 'label', {attributes: {type: "textblock", config: " "}}));
	fns.push(this.createEBVertexTemplateEntry('whiteSpace=wrap;fontColor=red;fontStyle=1;fontSize=15;fillColor=#F0F6FF;strokeColor=#0066CC;whiteSpace=wrap;rounded=1;html=0;align=center;verticalAlign=middle', 120, 40, 'Data value', 'Data value', null, null, 'label', {attributes: {type: "datavalue", config: " "}}));

	this.addPaletteFunctions('dashboard', 'Dashboard', true, fns);
}

Sidebar.prototype.createEBVertexTemplateEntry = function(style, width, height, value, title, showLabel, showTitle, tags,itemOption)
{
	tags = (tags != null && tags.length > 0) ? tags : title.toLowerCase();
	
	return this.addEntry(tags, mxUtils.bind(this, function()
 	{
 		return this.createEBVertexTemplate(itemOption,tags,style, width, height, value, title, showLabel, showTitle);
 	}));
}

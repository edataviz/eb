...
Sidebar.prototype.init = function()
{
    ...
    this.addImagePalette('energy', 'Energy', dir + '/draw2/', '_128x128.png',
        [
            'eb_oilwell','eb_gaswell','eb_oilmetter','eb_gasmetter','eb_watermetter','eb_oilpump','eb_waterpump','eb_oiltank','eb_watertank','eb_compressor','eb_flare','eb_separator','eb_waterinjection',
			...
			//'swimlane','rectangle','rounded','ellipse','rhombus','hexagon','triangle','actor','cylinder','cloud'
        ], null,
